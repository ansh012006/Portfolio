...
assert "#2dd4bf" in idx, "teal scheme missing"
assert "#070b12" in idx, "black base missing"
assert "#fb7185" not in idx, "old rose must go"
assert "#191224" not in idx, "old plum must go"
...
assert 'id="slides"' in idx, "project slider missing"
assert "pager" in idx, "slide pager missing"
assert "mousemove" in idx, "parallax handler missing"
assert "IntersectionObserver" in idx, "scroll reveal missing"
